...
const ManageIp = ({ collapsed }) => {
    ...
    return (
        <div className={`  ${collapsed ? 'ml-[4.5rem]' : 'ml-[14rem]'} relative  transition-all duration-300 w-screen mt-14 flex flex-wrap justify-center`}>   {/* 'h-screen items-center', flex-1 allows dashboard component to occupy remaining spaces */}
